...
def pickup():
    ...
    # Initial positions
    pi.set_servo_pulsewidth(SERVO1, 2400)
    pi.set_servo_pulsewidth(SERVO2, 800)
    pi.set_servo_pulsewidth(SERVO3, 630)
    time.sleep(0.5)

    # Move servos to pickup
    move_servo(SERVO2, 800, 1760)   # Rotate or lift
    time.sleep(0.5)


    move_servo(SERVO1, 2400, 1000)  # Arm raise
    time.sleep(0.5)

    move_servo(SERVO3, 630, 1250)  # Gripper close
    time.sleep(1)
